...
function Banner() {
  ...
  return (
    <div id="demo" className="banner carousel slide" data-ride="carousel">
      <div>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt, nam doloribus dolor cumque architecto perferendis tempore reprehenderit similique nobis tenetur ab dolore officia maiores fugit facilis odit porro sunt quod.
      </div>
