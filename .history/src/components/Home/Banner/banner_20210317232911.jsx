...
function Banner() {
  ...
  return (
    <div id="demo" className="banner carousel slide" data-ride="carousel">
      ...
      <div>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam, voluptates quia? Nemo ipsam quaerat, accusantium sed rerum dolorum nihil quibusdam optio consequatur expedita ab, et quos. Possimus eum voluptatem recusandae. lo
      </div>
    </div>
  );
}
